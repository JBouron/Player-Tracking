...
int main(int argc, char *argv[]) {
    ...
    player->original_image = cv::imread("./res/manual_extraction/frame5847,000000_originalimage0.jpg");
    player->mask_image = cv::imread("./res/manual_extraction/frame5847,000000_maskimage0.jpg");
